...
import { Genre, Actor, Genres } from '../models';
...
class ActorsComponent extends React.Component<WithStyles<typeof styles> | any, State, any> {
  ...
  state = {
    columns: [
      ...
      },
      {
        ...
        render: (rowData: Actor) => rowData.genres.map(key => <Chip label={key} key={key} className={this.props.classes.chips} />),
...
export const Actors = withStyles(styles)(ActorsComponent);